...
variable "edge_vpc_instance_tenancy" {
  type = string
...
variable "edge_vpc_enable_dns_support" {
  type = string
  description = "default is true. [true, false]]"
  default = "true"
}
variable "edge_vpc_enable_dns_hostnames" {
  type = string
...
variable "edge-vpn_additional_routes" {
  type = string
  description = "List of additonal routes to add in VPN"
  default = "[]"
}
variable "edge-vpn_number_additional_routes" {
  type = number
...
variable "edge-vpn_existing_vpn_id" {
  type = string
...
variable "edge-vpn_logs_retention" {
  type = string
...
variable "edge-vpn_authentication_type" {
  type = string
...
variable "ec2_access_key_access_key" {
  type = string
  description = "the value of ec2_access_key_access_key"
  default = ""
}
variable "ec2_access_key_secret_key" {
  type = string
  description = "the value of ec2_access_key_secret_key"
  default = ""
}
variable "ec2_access_key_name" {
  type = string
  description = "the value of ec2_access_key_name"
  default = ""
}
variable "ec2_access_key_label" {
  type = string
  description = "the value of ec2_access_key_label"
  default = "prd"
}
variable "ec2_access_key_public_key_file" {
  type = string
  description = "the value of ec2_access_key_public_key_file"
  default = ""
}
variable "ec2_access_key_private_key_file" {
  type = string
  description = "the value of ec2_access_key_private_key_file"
  default = ""
}
variable "ec2_access_key_public_key" {
  type = string
  description = "the value of ec2_access_key_public_key"
  default = ""
}
variable "ec2_access_key_private_key" {
  type = string
  description = "the value of ec2_access_key_private_key"
  default = ""
}
variable "ec2_access_key_rsa_bits" {
  type = number
  description = "the value of ec2_access_key_rsa_bits"
  default = 3072
}
variable "edge_bastion_pub_subnets_multi-zone" {
  type = bool
  description = "Create subnets in multiple zones"
  default = true
}
variable "edge_bastion_pub_subnets_label" {
  type = string
...
variable "edge_bastion_pub_subnets_availability_zones" {
  type = string
  description = "List of availability zone ids"
  default = "[]"
}
variable "edge_bastion_pub_subnets_customer_owned_ipv4_pool" {
  type = string
  description = "Type of the subnet: Public / Private"
  default = ""
}
variable "edge_bastion_pub_subnets_map_customer_owned_ip_on_launch" {
  type = string
...
variable "edge_bastion_pub_subnets_map_public_ip_on_launch" {
  type = string
...
variable "edge_bastion_pub_subnets_acl_rules" {
  type = string
  description = "the value of edge_bastion_pub_subnets_acl_rules"
  default = "[]"
}
variable "edge_bastion_pri_subnets_multi-zone" {
  type = bool
  description = "Create subnets in multiple zones"
  default = true
}
variable "edge_bastion_pri_subnets_label" {
  type = string
  description = "label to define type of subnet"
  default = "private"
}
variable "edge_bastion_pri_subnets_subnet_cidrs" {
  type = string
  description = "(Required) The CIDR block for the  subnet."
  default = "[\"10.0.4.0/24\",\"10.0.5.0/24\",\"10.0.6.0/24\"]"
}
variable "edge_bastion_pri_subnets_availability_zones" {
  type = string
  description = "List of availability zone ids"
  default = "[]"
}
variable "edge_bastion_pri_subnets_customer_owned_ipv4_pool" {
  type = string
  description = "Type of the subnet: Public / Private"
  default = ""
}
variable "edge_bastion_pri_subnets_map_customer_owned_ip_on_launch" {
  type = string
  description = "Specify true to indicate that network interfaces created in the subnet should be assigned a customer owned IP address. The customer_owned_ipv4_pool and  arguments must be specified when set to true. Default is false."
  default = "false "
}
variable "edge_bastion_pri_subnets_map_public_ip_on_launch" {
  type = string
  description = "(Optional) Specify true to indicate that instances launched into the subnet should be assigned a public IP address. Default is fals"
  default = "false"
}
variable "edge_bastion_pri_subnets_acl_rules" {
  type = string
  description = "the value of edge_bastion_pri_subnets_acl_rules"
  default = "[]"
}
